...
Change: `fix-benchmark-preparations-spec`. Preparation is not ready. A partial qualification attempt was launched and stopped; no Q4 or full-matrix arms have been launched by this change. Draft PR #2 continues the approved planning change after the explicitly authorized recovery from merged PR #1.
